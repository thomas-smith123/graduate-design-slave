...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOG, GPIO_Pin_7)
#define NRF_CSN_LOW()       GPIO_ResetBits(GPIOG, GPIO_Pin_7)		        //csn置低
#define NRF_CE_HIGH()	      GPIO_SetBits(GPIOG,GPIO_Pin_6)
#define NRF_CE_LOW()	      GPIO_ResetBits(GPIOG,GPIO_Pin_6)			      //CE置低
#define NRF_Read_IRQ()		  GPIO_ReadInputDataBit ( GPIOG, GPIO_Pin_8)  //中断引脚
